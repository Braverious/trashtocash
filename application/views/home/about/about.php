            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        ...
                        <p class="mb-3 op-8">Jika Anda memiliki pertanyaan, masalah, atau kendala terkait TrashtoCash, Anda
                            dapat menghubungi kami.</p>
                        <p class="tx-20 fw-500">Hubungi kami : <a href="https://wa.me/6281328000052?text=Halo%20TrashtoCash%" class="text-white me-1">0813-2800-0052</a> atau <a href="https://wa.me/6285692726913?text=Halo%20TrashtoCash%" class="text-white ms-1">0813-2800-0010</a></p>
                        <a href="https://wa.me/6281328000052?text=Halo%20TrashtoCash" class="btn btn-lg btn-secondary">Hubungi Sekarang</a>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                    <strong>Apa itu TrashtoCash?</strong>
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>TrashtoCash</strong> adalah sebuah proyek inovatif yang dirancang untuk
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <strong>Tujuan utama TrashtoCash?</strong>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <strong>Bagaimana cara kerja sistem penukaran sampah menjadi koin di TrashtoCash?</strong>
                                </button>
                            </h2>
...
<!-- Mirrored from codeigniter.spruko.com/hostma/hostma/about by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2024 04:45:23 GMT -->

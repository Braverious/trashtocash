                    ...
                    <ul class="nav list-unstyled align-items-center">
                        <li class="d-flex align-items-center position-relative me-md-4 me-2">
                            ...
                            <div class="d-none d-md-block">
                                <a href="javascript:void(0);" class="nav-link tx-15 p-0">Kontak TrashtoCash</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="mb-5">
                            ...
                            <p class="content-2">Lestarikan alam dengan daur ulang!.</p>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <span class="avatar br-7 me-3">
                                            <img style="width: 45px; height: auto;" src="<?= base_url('assets/images/svg/member-section2/') . $l['icon'] ?>">
                                        </span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card feature-card reveal">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Limbah yang Anda kumpulkan bisa berupa dan berbentuk apa saja sesuai dengan daftar jenis limbah yang
                                    dapat kami terima.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card feature-card reveal">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Jika limbah yang anda kumpulkan sesuai dengan daftar yang dapat kami terima,
                                    maka Anda akan mendapatkan saldo yang dapat dicairkan menjadi uang tunai.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card text-center feature-card-16 mb-lg-0">
                            <div class="card-body">
                                <span class="avatar br-7 me-3">
                                    <img style="width: 45px; height: auto;" src="<?= base_url('assets/images/svg/member-section2/') . $bp['icon'] ?>">
                                </span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card text-center feature-card-16 mb-lg-0 secondary">
                            <div class="card-body">
                                <span class="avatar br-7 me-3">
                                    <img style="width: 45px; height: auto;" src="<?= base_url('assets/images/svg/member-section2/') . $ka['icon'] ?>">
                                </span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card text-center feature-card-16 mb-lg-0 success">
                            <div class="card-body">
                                <span class="avatar br-7 me-3">
                                    <img style="width: 45px; height: auto;" src="<?= base_url('assets/images/svg/member-section2/') . $kk['icon'] ?>">
                                </span>
                                <h4 class="">Kardus</h4>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-lg-0">
                            <div class="position-relative">
                                <a href="#">
                                    <img class="card-img-top" src="assets/images/blog/pulp_trashtocash.jpg" alt="blog-image">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-lg-0">
                            <div class="position-relative">
                                <a href="#">
                                    <img class="card-img-top" src="assets/images/blog/alumunium_trashtocash.jpg" alt="blog-image">
                                </a>
                            </div>
                            <div class="card-body d-flex flex-column">
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-lg-0">
                            <div class="position-relative">
                                <a href="#">
                                    <img class="card-img-top" src="assets/images/blog/paving_trashtocash.jpg" alt="blog-image">
                                </a>
                            </div>
                            <div class="card-body d-flex flex-column">
